...
export const Login = () => {
  ...
  return (
    <Stack width={'100vw'} height={'100vh'} flexDirection={'row'} sx={{overflowY:"hidden"}}>
        ...
        <Stack bgcolor={'rgb(143, 181, 219)'} flex={1} justifyContent={'center'} >
        ...
        <Stack flex={1} justifyContent={'center'} alignItems={'center'}>
              ...
              <Stack flexDirection={'row'} justifyContent={'center'} alignItems={'center'}>
                ...
                <Stack rowGap={'.4rem'}>
                  <Typography variant='h1' sx={{wordBreak:"break-word", color: '#384959',}} fontWeight={600}>Edumart</Typography>
                  <Typography alignSelf={'flex-end'} color={'GrayText'} variant='body2'>~ Study Made Simple</Typography>
                </Stack>
